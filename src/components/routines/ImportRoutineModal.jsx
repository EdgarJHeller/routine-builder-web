...
export function ImportRoutineModal({ routine, t, onConfirm, onDismiss }) {
    if (!routine) return null;

    return (
        <div className="fixed inset-0 bg-surface-workout/60 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-4">
                ...
                <div className="bg-surface-subtle rounded-card p-4 mb-6">
                    ...
                    <p className="text-xs text-content-secondary font-bold tracking-wider mt-1">
                        ...
                        {routine.exercises?.length === 1
                            ? t.ui.exercise || "Exercise"
                            : t.ui.exercises || "Exercises"}
                        {" · "}
